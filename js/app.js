...
const applicationServerPublicKey = 'BKNELkcdXeGoT4Pa35DP52k3PwdF1tMLgXS2nkNfnXBbjmpG4J9h2b01CNpgqrj2GtQxEHFy7DCk1MK737mpud8';
...
function updateBtn() {
   ...
   if (Notification.permission === 'denied') {
    pushButton.textContent = 'Envío de notifiaciones bloqueado.';
    pushButton.disabled = true;
...
function subscribeUser() {
  ...
  .then(function(subscription) {
    console.log('El usuario está suscrito:', subscription);
